<div class="col-sm-12 col-lg-12 col-md-12"><div class="thumbnail2"><div class="caption"><h3><a href="#">Management Menu</a></h3><hr/><p>
<?
/*
Theme Name: School Template V.5.1
Theme URI: -
Description: Content Management System
Version: 5.1
Author: Hari Pratomo, admin@klatenweb.com
Author URI: http://klatenweb.com
*/
...
$admin .='<div class="border"><a href="?pilih=admin_menu"><b>Home</b></a> | <a href="?pilih=admin_menu&amp;aksi=addsub"><b>Create New Submenu</b></a></div>';
...
<table cellspacing="0" style="width:100%">
	...
	<th style="text-align:center;padding:10px 5px 10px 5px;border-top:1px solid #ccc;border-left:1px solid #ccc;">Publication</th>
...
$admin .='
	...
	<td style="text-align:left;padding:2px;border-top:1px solid #ccc;border-left:1px solid #ccc;"><a href="'.$subdata['url'].'">'.$subdata['menu'].'</a></td>
	<td style="text-align:center;padding:2px;border-top:1px solid #ccc;border-left:1px solid #ccc;">'.$ordering_up.'  '.$ordering_down.'</td>
...
if (isset($_POST['submit'])) {
	...
	if($hasil){
		$admin.='<div class="sukses">Menu Baru Berhasil diCreate</div>';
...
if (isset($_POST['submit'])) {
	...
	if($hasil){
		$admin.='<div class="sukses">Sub Menu baru telah diCreate.</div>';
		$style_include[] ='<meta http-equiv="refresh" content="1; url=?pilih=admin_menu" />';
	}		
	}
}
...
if(isset($_POST['submit'])){
	...
	if ($error){
		...
		$hasil  = mysql_query( "INSERT INTO `admin` (`menu` ,`url` ,`modul` ,`ordering`) VALUES ('$menu','$url','$modul','$ordering')" );
		if($hasil){
...
if(isset($_POST['submit'])){
	...
	if ($error){
		...
		$hasil  = mysql_query( "UPDATE `admin` SET `menu`='$menu' ,`url`='$url' ,`modul`='$modul' WHERE `id`='$id'" );
		if($hasil){
